        ...
        <Modal title={`Notify ${notifying.name}`} onClose={() => setNotifying(null)}>
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-500">
              Email is sent from the mailbox connected in Settings (replies go to the owner email). WhatsApp is sent from Reservly’s shared number and can include your Owner WhatsApp as the contact.
            </p>
